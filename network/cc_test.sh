...
docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["addWork", "a1", "title1", "m1", "100", "100"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["getInfos", "myCompany"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["addWork", "a2", "title2", "m2", "100", "100"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["getInfos", "a2"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["getInfos", "myCompany"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["addWork", "a3", "title3", "m3", "100", "100"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["getInfos", "myCompany"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["addWork", "a4", "titl4", "m4", "100", "100"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["getInfos", "myCompany"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3

docker exec cli peer chaincode invoke -n ArtWork -C myart -c '{"Args":["addWork", "a5", "title5", "m5", "100", "100"]}' --peerAddresses peer0.org1.artwork.com:7051 peer0.org1.artwork.com:8051
sleep 3
