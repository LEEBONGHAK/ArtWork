...
# linux /home/bstudent/fabric-samples/chaincode/ArtWork -> cli /opt/gopath/src/github.com/ArtWork
...
# 배포 peer0.org1.artwork.com  -> dev-ArtWork 인도서 피어 컨테이너가 생성, 커미터 피어 couchdb mychannel_papercontract 테이블이생성
